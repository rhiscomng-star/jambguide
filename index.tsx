...
const getJambAdvice = async (userQuery: string) => {
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction: "You are an expert JAMB (Joint Admissions and Matriculation Board) consultant. You help Nigerian students navigate the registration process. Do not mention specific prices as they vary. Always emphasize using the correct NIN and active mobile numbers."
      }
    });
...
const App: React.FC = () => {
  ...
  const steps = [
    { 
      ...
      content: (
        <div className="space-y-4 animate-fadeIn">
          <p className="text-gray-700">The profile code is your unique identifier for the entire JAMB season.</p>
          <div className="bg-green-50 p-5 rounded-2xl border border-green-100">
            ...
            <div className="bg-white p-4 rounded-xl border border-dashed border-green-300 font-mono text-center">
              <p className="text-xs text-gray-500 mb-1 uppercase tracking-widest">Type and Send to 55019 or 66019</p>
              <p className="text-xl font-bold text-green-700">NIN 12345678901</p>
            </div>
          </div>
          <div className="bg-white p-4 border border-gray-100 rounded-2xl shadow-sm">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex gap-2"><span>•</span> <span>One NIN per profile code.</span></li>
              <li className="flex gap-2"><span>•</span> <span>Active mobile number (SIM card).</span></li>
              <li className="flex gap-2"><span>•</span> <span>Airtime for SMS charges (Standard rates apply).</span></li>
            </ul>
          </div>
        </div>
      )
    ...
    { 
      ...
      content: (
        <div className="space-y-4 animate-fadeIn">
          <p className="text-gray-700">Once you have your profile code, purchase the e-PIN to unlock the registration portal.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="p-4 border border-gray-100 rounded-2xl bg-white hover:border-green-500 transition-all group">
              <h5 className="font-bold group-hover:text-green-700">Online Channels</h5>
              <p className="text-xs text-gray-500">Remita, Interswitch, Paga, or Quickteller.</p>
            </div>
            <div className="p-4 border border-gray-100 rounded-2xl bg-white hover:border-green-500 transition-all group">
              <h5 className="font-bold group-hover:text-green-700">Commercial Banks</h5>
              <p className="text-xs text-gray-500">FirstBank, Zenith, GTB, Union Bank, etc.</p>
            </div>
          </div>
          <p className="text-xs text-amber-600 bg-amber-50 p-3 rounded-lg border border-amber-100 italic">
            * Ensure the profile code you provide at the point of payment is 100% correct.
          </p>
        </div>
      )
    },
    { 
      ...
      content: (
        <div className="space-y-4 animate-fadeIn">
          <p className="text-gray-700">Complete your registration at any <strong>Accredited JAMB CBT Center</strong> nationwide.</p>
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="flex gap-3 items-center bg-white p-4 rounded-xl border border-gray-50 shadow-sm">
                <div className="w-6 h-6 bg-green-100 text-green-700 rounded-full flex items-center justify-center text-xs font-bold">{idx + 1}</div>
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight text-gray-900">JAMB 2026</h1>
              <p className="text-[10px] font-bold text-green-700 uppercase tracking-widest leading-none">Registration Guide</p>
            </div>
          </div>
          <button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div key={step.id} className="animate-fadeIn">
                <div className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-8 opacity-5 text-green-700">
                    ...
                    {React.cloneElement(step.icon as React.ReactElement<any>, { size: 120 })}
                  </div>
                  
                  <div className="relative z-10">
                    <h2 className="text-3xl font-black mb-2 text-gray-900">{step.title}</h2>
                    <p className="text-gray-500 mb-8 font-medium">{step.description}</p>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex gap-4 items-start p-3 bg-gray-50 rounded-2xl">
                    <div className="w-5 h-5 mt-1 bg-green-100 text-green-700 rounded-full flex items-center justify-center"><CheckCircle2 size={12} /></div>
                    <div>
            ...
            <div className="bg-green-700 rounded-[2rem] p-6 text-white shadow-xl relative overflow-hidden group">
              ...
              <p className="text-xs text-green-100 mb-6 font-medium relative z-10">Our AI Assistant is available 24/7 to guide you through registration issues.</p>
              <button 
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold text-green-100 uppercase tracking-widest">Online</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 h-[400px]">
            {chatHistory.length === 0 && (
              <div className="text-center py-12 px-6">
                ...
                <h5 className="font-bold text-gray-800 mb-1">Hello Future Candidate!</h5>
                <p className="text-xs text-gray-500 font-medium">Ask me anything about NIN, Profile Codes, or CBT Centers.</p>
              </div>
            )}
      ...
      {showVideo && (
        <div className="fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-4 backdrop-blur-md animate-fadeIn">
          <div className="relative w-full max-w-5xl aspect-video rounded-3xl overflow-hidden shadow-2xl ring-1 ring-white/20">
            ...
            <iframe className="w-full h-full" src={showVideo} frameBorder="0" allowFullScreen></iframe>
          </div>
        </div>
      )}
      ...
      {showInstallGuide && (
        <div className="fixed inset-0 z-[100] bg-black/60 flex items-center justify-center p-4 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white w-full max-w-md rounded-[2.5rem] p-10 shadow-2xl relative text-center">
            <button onClick={() => setShowInstallGuide(false)} className="absolute top-6 right-6 p-2 text-gray-400 hover:text-gray-600">
              <X size={24} />
            </button>
            ...
            <p className="text-gray-500 text-sm mb-8 font-medium">Install this guide to your device for offline access and faster updates.</p>
            ...
            <div className="space-y-4 text-left mb-8">
              {[
                ...
                <div key={i} className="flex gap-4 items-center bg-gray-50 p-4 rounded-2xl border border-gray-100">
                  <div className="w-8 h-8 bg-green-700 text-white text-xs font-black flex items-center justify-center rounded-xl">{item.s}</div>
